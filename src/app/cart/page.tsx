...
import { ShoppingBag, ShoppingCart, ArrowRight, Banknote, CreditCard } from "lucide-react";
                    ...
                    <div className="lg:col-span-1 sticky top-24">
                        <div className="bg-slate-900 rounded-3xl p-8 text-white shadow-2xl relative overflow-hidden">
                            ...
                            <div className="flex flex-col gap-4 mt-8">
                                <Link
                                    href="/checkout/visa"
                                    className="w-full bg-slate-600 text-white font-black py-4 px-6 rounded-2xl hover:bg-slate-700 transition-all flex items-center justify-between group  shadow-slate-200"
                                >
                                    <div className="flex items-center gap-3">
                                        <div className="bg-slate-800 p-2 rounded-lg group-hover:scale-110 transition-transform">
                                            <CreditCard size={22} className="text-yellow-400" />
                                        </div>
                                        <span className="uppercase tracking-wider text-sm">Pay with Visa / Card</span>
                                    </div>
                                    <ArrowRight className="group-hover:translate-x-1 transition-transform opacity-50 group-hover:opacity-100" size={20} />
                                </Link>

                                <Link
                                    href="/checkout/cash"
                                    className="w-full bg-yellow-400 text-slate-900 font-black py-4 px-6 rounded-2xl hover:bg-yellow-500 transition-all flex items-center justify-between group shadow-lg shadow-yellow-400/20"
                                >
                                    <div className="flex items-center gap-3">
                                        <div className="bg-yellow-300 p-2 rounded-lg group-hover:scale-110 transition-transform">
                                            <Banknote size={22} />
                                        </div>
                                        <span className="uppercase tracking-wider text-sm">Cash On Delivery</span>
                                    </div>
                                    <ArrowRight className="group-hover:translate-x-1 transition-transform opacity-50 group-hover:opacity-100" size={20} />
                                </Link>
                            </div>
